        ...
        <form:form>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <form:input path="firstName" type="email" class="form-control" id="inputEmail4"/>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Last Name</label>
                    <form:input path="lastName" type="email" class="form-control" id="inputEmail4"/>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <form:input path="zip" type="text" class="form-control" id="inputZip"/>
                </div>
            </div>
